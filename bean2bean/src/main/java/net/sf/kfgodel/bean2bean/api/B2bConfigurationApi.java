...
public interface B2bConfigurationApi {
     ...
     * This implicit mapper will try to create a mapping using shared property names between source and destination type.<br>
     ...
     * }<br>
     * <br>
     * When converting A to B, you will get a B instance with "firstProperty" value from A instance, converted from String to Integer, and assigned to B.
