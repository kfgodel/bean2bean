...
import info.kfgodel.bean2bean.v3.core.impl.nesting.NestedBean2bean;
...
/**
 * This class represents the task that {@link info.kfgodel.bean2bean.v3.core.api.Bean2bean} can process
