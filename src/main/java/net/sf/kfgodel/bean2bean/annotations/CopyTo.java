/**
 * Created on: 14/01/2009 16:19:53 by: Dario L. Garcia
 * 
...
/**
 * This annotation marks bean fields that must be copied to destination bean using setter
 * expression.<br>
 * <br>
...
public @interface CopyTo {
	...
	/**
	 * Expression for getting the value to copy. This expression is evaluated in source object (the
	 * annotated one). This can be any valid value in the language defined by
	...
	/**
	 * Interpreter type to use when executing {@link #getter()} expression.<br>
