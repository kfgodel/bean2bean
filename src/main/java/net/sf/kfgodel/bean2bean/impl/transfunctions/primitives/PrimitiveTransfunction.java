...
/**
 * This class serves as a namespace for primitive conversion transfunctions
 *
 * Created by kfgodel on 05/07/16.
 */
public class PrimitiveTransfunction {
   ...
   */
  public static Long stringToLong(String input) throws IllegalArgumentException, Bean2beanException {
    if(input == null){
