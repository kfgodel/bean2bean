    ...
    describe("a collection converter registered with b2b", () -> {
      ...
      describe("by itself", () -> {
        ...
        itThrows(CreationException.class, "if no creation converter is registered", () -> {
          ...
          assertThat(e).hasMessage("Creation of java.util.Set<java.lang.String> failed: No converter found from void ∈ {java.lang.Void} to {java.util.Set<java.lang.String>}");
        });
