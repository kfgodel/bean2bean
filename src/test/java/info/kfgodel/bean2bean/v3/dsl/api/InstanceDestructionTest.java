    ...
    describe("a b2b dsl", () -> {
      ...
      describe("with a default configuration", () -> {
        ...
        itThrows(DestructionException.class, "when any destruction is attempted", () -> {
          ...
          assertThat(e).hasMessage("Destruction of \"any object\" failed: No converter found from \"any object\" ∈ {java.lang.String} to {info.kfgodel.bean2bean.v3.dsl.api.Nothing}");
        });
      });
