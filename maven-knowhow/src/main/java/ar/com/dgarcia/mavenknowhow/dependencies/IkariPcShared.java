/**
 * 05/01/2012 23:06:16 Copyright (C) 2011 Darío L. García
 * 
...
/**
 * Esta clase representa las dependencias necesarias comunes a los proyectos de IkariPC
 * 
 * @author D. García
 */
public class IkariPcShared extends ProjectDependency {
	...
	protected void declareJarDependencies(final List<Dependency> dependencies) {
		dependencies.add(Dependencies.create("ar.com.dgarcia", "ikaripc-shared", "0.1"));
	}

	public static IkariPcShared create() {
		final IkariPcShared ikari = new IkariPcShared();
		return ikari;
	}
