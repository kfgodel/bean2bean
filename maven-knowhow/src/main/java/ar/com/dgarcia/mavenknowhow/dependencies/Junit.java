/**
 * 28/12/2011 19:15:34 Copyright (C) 2011 Darío L. García
 * 
...
/**
 * Esta clase representa la dependencias de Junit para testeo
 * 
 * @author D. García
 */
public class Junit extends ProjectDependency {
	...
	protected void declareJarDependencies(final List<Dependency> dependencies) {
		final Dependency junit = Dependencies.create("junit", "junit", "4.8.1");
		junit.setScope("test");
		dependencies.add(junit);
	}

	public static Junit create() {
