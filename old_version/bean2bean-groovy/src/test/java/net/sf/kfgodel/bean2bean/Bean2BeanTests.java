...
import net.sf.kfgodel.bean2bean.GroovyPopulationTest;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses( { PopulationTest.class, ConverterTest.class, PropertyCopyTest.class, SpringInjectionTest.class,
