...
public class GroovyClasePopuladora {
	...
	// TODO: Este mapeo no debería pinchar
	// Utiliza una anotacion auxiliar para especificar el patron en la
	// conversion (usa conversor especial)
	// @CopyTo(value = "_destino.conApostrofes = _valor", getterInterpreter =
	// InterpreterType.GROOVY, setterInterpreter = InterpreterType.GROOVY, useConversor =
	// "net.sf.kfgodel.bean2bean.conversion.converters.FormatterConverter", contextAnnotations =
	// FormatterPattern.class)
	@FormatterPattern("'%s'")
	...
	public void verificarContra(ClasePopulada populada) {
		...
		// TODO: Agregar este equals al resolver el BB-59
