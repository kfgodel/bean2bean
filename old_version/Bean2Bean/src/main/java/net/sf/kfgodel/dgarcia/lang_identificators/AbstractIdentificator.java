 ...
 * {@link net.sf.kfgodel.dgarcia.lang_identificators.Identificator} que se basa en el discriminator
 * para implementar los demas metodos
 * 
 * @param <T>
 *            Tipo de los objetos de este dominio
 * @version 1.0
 * @since 2006-03-23
 * @author D. Garcia
 */
public abstract class AbstractIdentificator<T> implements Identificator<T> {
	...
	/**
	 * Compara dos objetos cualquiera a traves de su discriminante
	 * 
	 * @param first
	 *            Instancia usada de referencia o null
	 * @param second
	 *            Instancia comparada o null
	...
	/**
	 * Indica si dos objetos son considerados iguales utilizando su discriminante
	 * 
	 * @param first
	...
	/**
	 * Devuelve el discriminante a utilizar por este identificador. Es responsabilidad de las
	 * subclases
	 * 
	 * @param object
