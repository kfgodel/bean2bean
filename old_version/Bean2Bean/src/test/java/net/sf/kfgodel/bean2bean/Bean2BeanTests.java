...
import net.sf.kfgodel.bean2bean.tutorial.TutorialExampleTest;
...
@SuiteClasses( { PopulationTest.class, BeanCreationTest.class, ConverterTest.class, PropertyCopyTest.class,
		CopyFromAndToTest.class, SpringInjectionTest.class, TutorialExampleTest.class, OgnlPopulationTest.class,
		GroovyPopulationTest.class, ReflectionPopulationTest.class })
