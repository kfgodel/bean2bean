...
public class ReflectionClasePopulable {
	...
	// Copia desde una propiedad accesible a una que no tiene setter pero si getter
	@CopyFrom("propiedadPrimitiva")
	private String propiedadSinSetter;
	...
	public String getPropiedadSinSetter() {
		return propiedadSinSetter;
	}
