/**
 * Created on: 21/08/2008 13:46:09 by: Dario L. Garcia
 * 
 ...
 * 
 */
package net.sf.kfgodel.bean2bean.testconverter;
...
public class SpecializedTestConverter implements SpecializedTypeConverter<Object, Class<?>> {
	 ...
	 */
	public Class<?> convertTo(Type expectedType, Object sourceObject, Annotation[] contextAnnotations)
